        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="bg-white border-b border-gray-200">
                    ...
                    <form class="w-full p-5" method="POST" action="{{ route('candidates.store') }}"
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/3 px-3">
                                ...
                                <input
                                    ...
                                    id="email" name="email" type="email" required placeholder="Enter e-mail...">
                            </div>
                            <div class="w-full md:w-1/3 px-3">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                       for="min_salary">
                                ...
                                <input
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    id="min_salary" name="min_salary" type="number" min="0" max="999999.9" step=".1"
                            ...
                            <div class="w-full md:w-1/3 px-3">
                                ...
                                <input
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    id="max_salary" name="max_salary" type="number" min="0" max="999999.9" step=".1"
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/3 px-3">
                                ...
                                <input
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    id="education" name="education" type="text" placeholder="Enter education...">
                            </div>
                            <div class="w-full md:w-1/3 px-3">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            ...
                            <div class="w-full md:w-1/3 px-3">
                                ...
                                <select
                                    class="skills-select lock appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    name="skills[]" id="skills" multiple="multiple">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-4">
                            <div class="w-full md:w-full px-3">
                                ...
                                <textarea
                                    ...
                                    placeholder="Enter description / comment..."></textarea>
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-4">
                            <div class="w-full md:w-full px-3">
